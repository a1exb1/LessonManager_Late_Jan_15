...
class DVDatePickerTableViewCell: UITableViewCell {
    ...
    var date:NSDate = NSDate() {
        didSet {
            ...
            rightLabel.text = Tools.StringFromDate(date, format: LMDateFormat.Date.rawValue)
        }
    }
    ...
    var identifier = ""
    var delegate:DVDatePickerDelegate? = nil
    
    init(var textLabelText:String, var identifier:String, var date:NSDate){
...
//    }
    ...
    func datePicked() {
        ...
        delegate?.DVDatePickerDateDidChange(self.identifier, date: date)
    }
}