...
class CalenderMonthCollectionViewCell: UICollectionViewCell {
    ...
    var cellIndicatorImageView: UIImageView!
    ...
    func addCellIndicator(){
        ...
        cellIndicatorImageView.addBottomConstraint(toView: cellIndicatorImageView.superview, attribute: NSLayoutAttribute.Bottom, relation: NSLayoutRelation.Equal, constant: -4)
